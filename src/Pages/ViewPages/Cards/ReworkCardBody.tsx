                        ...
                        {isMobile ? (
                            <>
                                <div style={{
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', justifyContent: 'center', width: '100%', flex: '1 1 0', minWidth: 0 }}>
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', flex: '1 1 0', minWidth: 0, flexShrink: 0 }}>
                                        {imagePaths.length > 0 ? (
                                            <button 
                            ...
                            <>
                                {/* Column 1: Time (2x width) */}
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', justifyContent: 'center', flex: '2 2 0%', minWidth: 0 }}>
                                    <span style={{ fontSize: '0.9rem', color: 'var(--text)', fontWeight: 600 }}>
                                        {new Date(rework.timestamp).toLocaleDateString()}
                                    </span>
                                    <span style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>
                                ...
                                {/* Column 2: User/Type & Photos (2x width) */}
                                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', justifyContent: 'center', flex: '2 2 0%', minWidth: 0 }}>
                                    <div style={{ 
                                        display: 'inline-flex', 
                                        alignItems: 'center', 
                                ...
                                {/* Column 3: Description (8x width) */}
                                <div className="rework-description-col" style={{ flex: '8 8 0%', minWidth: 0 }}>
                                    {rework.description && rework.description.trim() ? (
                                        <p 
                                            style={{ 
                                                margin: 0, 
